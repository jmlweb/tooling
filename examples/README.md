...
This directory contains example projects demonstrating how to use `@jmlweb` tooling packages in real-world scenarios.

> **Note:** Examples have been moved to [`apps/`](../apps) directory. See the individual example apps:
>
> - [`example-nodejs-typescript-api`](../apps/example-nodejs-typescript-api)
> - [`example-react-typescript-app`](../apps/example-react-typescript-app)
> - [`example-nodejs-javascript`](../apps/example-nodejs-javascript)

## Available Examples

### 1. Node.js TypeScript API

**Location:** [`example-nodejs-typescript-api/`](../apps/example-nodejs-typescript-api)
...
**Location:** [`example-react-typescript-app/`](../apps/example-react-typescript-app)
...
**Location:** [`example-nodejs-javascript/`](../apps/example-nodejs-javascript)
...
- **TypeScript API?** → Use [`example-nodejs-typescript-api/`](../apps/example-nodejs-typescript-api)
- **React App?** → Use [`example-react-typescript-app/`](../apps/example-react-typescript-app)
- **JavaScript Only?** → Use [`example-nodejs-javascript/`](../apps/example-nodejs-javascript)
