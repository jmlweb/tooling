...
editUrl: https://github.com/jmlweb/tooling/blob/main/packages/tsconfig-base/README.md
sidebar:
  order: 1
---
...
- [`@jmlweb/eslint-config-base`](/eslint/base) - ESLint configuration for TypeScript projects
- [`@jmlweb/prettier-config-base`](/prettier/base) - Prettier configuration
- [`@jmlweb/tsconfig-react`](/typescript/react) - TypeScript configuration for React projects
...
For version history, see the [Changelog](https://github.com/jmlweb/tooling/blob/main/packages/tsconfig-base/CHANGELOG.md).

**Need Help?** If you encounter issues during migration, please [open an issue](https://github.com/jmlweb/tooling/issues/new).

## 📜 Changelog

See [CHANGELOG.md](https://github.com/jmlweb/tooling/blob/main/packages/tsconfig-base/CHANGELOG.md) for version history and release notes.
