...
editUrl: https://github.com/jmlweb/tooling/blob/main/packages/jest-config/README.md
sidebar:
  order: 1
---
...
**For projects using Vitest**, use [`@jmlweb/vitest-config`](/testing/vitest) instead.
...
- [`@jmlweb/vitest-config`](/testing/vitest) - Vitest configuration for modern testing
...
For version history, see the [Changelog](https://github.com/jmlweb/tooling/blob/main/packages/jest-config/CHANGELOG.md).

**Need Help?** If you encounter issues during migration, please [open an issue](https://github.com/jmlweb/tooling/issues/new).

## 📜 Changelog

See [CHANGELOG.md](https://github.com/jmlweb/tooling/blob/main/packages/jest-config/CHANGELOG.md) for version history and release notes.
