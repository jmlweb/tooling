...
editUrl: https://github.com/jmlweb/tooling/blob/main/packages/eslint-config-react/README.md
sidebar:
  order: 1
---
...
**For non-React TypeScript projects**, use [`@jmlweb/eslint-config-base`](/eslint/base) instead.
...
- [`@jmlweb/tsconfig-react`](/typescript/react) - TypeScript configuration for React libraries
...
For version history, see the [Changelog](https://github.com/jmlweb/tooling/blob/main/packages/eslint-config-react/CHANGELOG.md).

**Need Help?** If you encounter issues during migration, please [open an issue](https://github.com/jmlweb/tooling/issues/new).

## 📜 Changelog

See [CHANGELOG.md](https://github.com/jmlweb/tooling/blob/main/packages/eslint-config-react/CHANGELOG.md) for version history and release notes.
