...
editUrl: https://github.com/jmlweb/tooling/blob/main/packages/eslint-config-node/README.md
sidebar:
  order: 1
---
...
**For non-Node.js TypeScript projects**, use [`@jmlweb/eslint-config-base`](/eslint/base) instead.
...
- [`@jmlweb/tsconfig-node`](/typescript/node) - TypeScript configuration for Node.js libraries
...
For version history, see the [Changelog](https://github.com/jmlweb/tooling/blob/main/packages/eslint-config-node/CHANGELOG.md).

**Need Help?** If you encounter issues during migration, please [open an issue](https://github.com/jmlweb/tooling/issues/new).

## 📜 Changelog

See [CHANGELOG.md](https://github.com/jmlweb/tooling/blob/main/packages/eslint-config-node/CHANGELOG.md) for version history and release notes.
